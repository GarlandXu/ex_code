...
Your_path
from identify.vision_utilities import *
...
class PointCloudSubscriber():
    def __init__(self):
        ...
        rospy.Subscriber("approve_head_click",String,self.callback_switch)
...
if __name__ =='__main__':
    rospy.init_node("appendix_head_subscriber")
